    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <main>
        <section id="home" className="py-12">
          <div className="flex flex-col justify-between container mx-auto h-[calc(100vh-98px)] py-8 ">
            <h2 className="text-3xl text-green-500 font-bold mb-6">Welcome to ABTECH iREPAIR!</h2>
            <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="mb-6">
                  At <span className='text-green-500'>ABTECH iREPAIR</span>, we have over 5 years of experience in providing top-notch repair services for laptops, phones, and PCB boards. Our mission is to get your devices back to full functionality as quickly as possible, using high-quality parts and advanced tools.
                </p>
                <p className="mb-6">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-blue-500">Why Choose Us?</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative w-50 h-50 pb-[100%] rounded-full overflow-hidden">
                  <Image
                  src={pics1}
              ...
              <div className="mt-8 text-center">
                <div className="flex flex-col sm:flex-row gap-10 justify-center">
                  ...
                  <Link href="/trainee-registration" className="inline-flex items-center bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition duration-300">
                    <FileText className="mr-2" />
                    Register as a Trainee
                  </Link>
                </div>
              </div>
            <div className="flex flex-col justify-between md:flex-row gap-6 pt-10">
              ...
              {/* <div className="mb-8 flex justify-center">
                <Link href="/trainee-registration">
                  <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded shadow-lg transition-all duration-200">
                    Register as a Trainee
                  </button>
                </Link>
              </div> */}
        ...
        <section id="services" className="py-12 bg-gray-800">
          <div className="flex flex-col min-h-[calc(100vh-96px)] justify-between container mx-auto px-4 pt-12">
        ...
        <section id="contact" className="py-12">
          <div className="flex flex-col min-h-[calc(100vh-96px)] justify-evenly container mx-auto px-4 pt-12">
